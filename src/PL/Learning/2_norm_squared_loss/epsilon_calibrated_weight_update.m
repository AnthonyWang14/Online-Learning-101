function [ new_weights, loss ] = epsilon_calibrated_weight_update( old_weights, predictions, match_number, eta, epsilon)
...
for i=1:length(old_weights)
    ...
    loss(i)=epsilon_calibrated_loss(current_prediction, match_number, i, epsilon);
